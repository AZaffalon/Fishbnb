class BookingsController < ApplicationController
  ...
  def create
    ...
    @booking = Booking.new(start_at: @start_at, end_at: @end_at, fish: @fish,
      user: current_user, current_cost: @current_cost)
  ...
  def edit
    @fish = Fish.find(params[:fish_id])
    @statuses = ['En attente', 'Validée', 'Non validée']
    authorize @booking
  end
  ...
  def booking_params
    params.require(:booking).permit(:start_at, :end_at, :current_status, :current_cost)
  end
